...
my $help              = 0;
my $host              = undef;
my $port              = $ENV{EZ_360_PORT} || $ENV{CATALYST_PORT} || 3000;
my $keepalive         = 0;
my $restart           = $ENV{EZ_360_RELOAD} || $ENV{CATALYST_RELOAD} || 0;
my $background        = 0;
my $pidfile           = undef;
...
ez_360_server.pl - Catalyst Testserver

=head1 SYNOPSIS

ez_360_server.pl [options]
